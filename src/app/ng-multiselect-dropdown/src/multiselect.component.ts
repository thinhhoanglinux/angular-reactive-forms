...
export class MultiSelectComponent implements ControlValueAccessor {
  ...
  @Output('filterChange') filterChange: EventEmitter<ListItem> = new EventEmitter<any>();

  @Output('select') select: EventEmitter<ListItem> = new EventEmitter<any>();

  @Output('deSelect') deSelect: EventEmitter<ListItem> = new EventEmitter<any>();

  @Output('selectAll') selectAll: EventEmitter<Array<ListItem>> = new EventEmitter<Array<any>>();

  @Output('deSelectAll') deSelectAll: EventEmitter<Array<ListItem>> = new EventEmitter<Array<any>>();
